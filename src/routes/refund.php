...
$app->post('/api/Adyen/refund', function ($request, $response) {

    $settings = $this->settings;
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['username','password','merchantAccount','originalReference','modificationAmount']);
    ...
    $query_str = "https://pal-test.adyen.com/pal/servlet/Payment/v30/refund";
