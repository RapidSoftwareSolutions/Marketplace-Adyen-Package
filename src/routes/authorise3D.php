...
$app->post('/api/Adyen/authorise3D', function ($request, $response) {
    ...
    $validateRes = $checkRequest->validate($request, ['username','password','md','merchantAccount','paResponse']);
