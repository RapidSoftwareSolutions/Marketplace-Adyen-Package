...
$app->post('/api/Adyen/authorise', function ($request, $response) {
    ...
    $requiredParams = ['username'=>'username','password'=>'password','amountCurrency'=>'amountCurrency','amountValue'=>'amountValue','merchantAccount'=>'merchantAccount','reference'=>'reference'];
